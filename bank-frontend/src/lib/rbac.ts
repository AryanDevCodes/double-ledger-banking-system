...
export const PERMISSIONS = {
  ...
  TRANSACTIONS_CREATE: [ROLES.ADMIN, ROLES.MANAGER, ROLES.USER],
  ...
  UPI_PAY: [ROLES.ADMIN, ROLES.MANAGER, ROLES.USER],

  // Payment Operations (Customer Features)
  PAYMENTS_SEND: [ROLES.ADMIN, ROLES.MANAGER, ROLES.USER],
  PAYMENTS_VIEW_HISTORY: [ROLES.ADMIN, ROLES.MANAGER, ROLES.AUDITOR, ROLES.USER],
  PAYMENTS_UPI: [ROLES.ADMIN, ROLES.MANAGER, ROLES.USER],
  PAYMENTS_BANK_TRANSFER: [ROLES.ADMIN, ROLES.MANAGER, ROLES.USER],
