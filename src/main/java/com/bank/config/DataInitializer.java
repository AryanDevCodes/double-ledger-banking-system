...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeUsers() {
        ...
        // ARYAN users based on customer data
    ...
    private void createUserIfNotExists(String username, String email, String fullName, String phone, Role userRole) {
    ...
    private void linkCustomersToUsers() {
        ...
        // Find all customers with null user_id
                ...
                .forEach(customer -> {
                    ...
                    userRepository.findAll().stream()
                            ...
                            .ifPresent(user -> {
                                ...
                                log.info("Linked customer {} to user {}", customer.getId(), user.getUsername());
                            });
                });
