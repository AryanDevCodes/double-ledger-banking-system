...
public class Account {
  ...
  private List<Transaction>
      sentTransactions; /*    @PrePersist    private void setAccountNumber() {        if (bank != null) {            this.accountNumber = bank.getBankName() + "_" + UUID.randomUUID().toString();        } else {            throw new IllegalStateException("Bank must be set before persisting the account.");        }    }*/
}
